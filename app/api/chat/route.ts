...
export async function POST(req: Request) {
  try {
    ...
    const template = {
      role: "system",
      content: `You are an AI assistant who knows everything about Samdev. Use the below context to augment what you know about Samdev, the innovative technology company. The context will provide you with the most recent data from official Samdev sources and others. If the context doesn't include the information you need, answer based on your existing knowledge and don't mention the source of your information or what the context does or doesn't include. Format responses using markdown where applicable and don't return images.
