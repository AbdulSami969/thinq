        ...
        <div className="offCanvas__side-info mb-30">
          <div className="contact-list mb-30">
            ...
            <div className="mb-3">
              ...
              <p className="mb-0">+923488488488</p>
            </div>
            <div className="mb-3">
              <span className="text-400 fs-5">Email</span>
              <p className="mb-0">abdulsami8777@gmail.com</p>
            </div>
            {/* <div className="mb-3">
          ...
          <div className="contact-list">
            ...
            <div className="d-md-flex d-none gap-3">
              ...
              <Link href="https://www.linkedin.com/in/abdulsami488/" target="_blank">
                <i className="ri-linkedin-fill fs-18" />
              </Link>
              <Link href="https://github.com/AbdulSami969" target="_blank">
                <i className="ri-github-fill fs-18" />
              </Link>
              <Link href="https://dribbble.com/samiabd1" target="_blank">
                <i className="ri-dribbble-fill fs-18" />
              </Link>
              <Link href="https://www.behance.net/abdulsami110" target="_blank">
