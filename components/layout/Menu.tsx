  ...
  return (
    <>
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <Link href="/#testimonials" className={pathname === "/work" ? "nav-link active" : "nav-link"}>
            Testimonials
          </Link>
        </li>
        {/* <li className="nav-item">
        ...
        <li className="nav-item">
          <Link href="https://samiverse.hashnode.dev/" target="_blank" className={pathname === "/blog-list" ? "nav-link active" : "nav-link"}>
            Blog
          </Link>
        </li>
        <li className="nav-item">
